...
#pragma region Windows Form Designer generated code
	...
	private:
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(25, 160);
			...
			this->textBox1->Location = System::Drawing::Point(109, 136);
			...
			this->label1->Location = System::Drawing::Point(106, 98);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(317, 278);
			...
			this->label2->Location = System::Drawing::Point(147, 18);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(263, 16);
			this->label2->TabIndex = 10;
			this->label2->Text = L"Incrementarea decrementarea contor";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(215, 44);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(90, 15);
			this->label3->TabIndex = 11;
			this->label3->Text = L"i scade in Edit1";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Besliu Doina TI-143";
			// 
			// MyForm
			// 
